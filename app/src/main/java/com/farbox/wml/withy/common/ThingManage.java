...
public class ThingManage {
    ...
    static {
        ...
        defaultThings.add(new Thing(15, "用影视剧对白说只有两个人才明白的话", 15, 1));
        ...
        defaultThings.add(new Thing(22, "有好消息或者坏消息要第一个告诉对方", 22, 0));
        defaultThings.add(new Thing(23, "永远不说谢谢", 23, 0));
        defaultThings.add(new Thing(24, "下雨天同撑一把伞", 24, 0));
        defaultThings.add(new Thing(25, "养花 互相提醒着浇水和给它们晒太阳", 25, 0));
        defaultThings.add(new Thing(26, "异口同声地说出同一句话", 26, 0));
        defaultThings.add(new Thing(27, "深夜观星", 27, 0));
